...
let lanes = [{lines: [], speed: 3}, {lines: [], speed: 3}]; 
let lineSpacing =34; 
let horizonY = 101; 
let roadWidthTop = 50; 
...
let enemyData = {
    tronc: {
        img: 'assets/sprites/enemy_sprite.png',
        scale: 0.1,
        speed: 3,
        width: 20,
        height: 30,
    ...
    tronc2: {
        img: 'assets/sprites/enemy_sprite_2.png',
        scale: 0.1,
        speed: 3,
        width: 30,
        height: 15,
...
function preload() {
    backgroundImg = loadImage('assets/backgrounds/decor_city.png');
...
function draw() {
    ...
    if(gameState===END){
        ...
        lanes = [{lines: [], speed: 3}, {lines: [], speed: 3}];
        timerValue = 60;
