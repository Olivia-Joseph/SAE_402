...
let lanes = [{lines: [], speed: 2}, {lines: [], speed: 2}]; 
let lineSpacing =34; 
let horizonY = 96; 
let roadWidthTop = 50; 
...
let enemyData = {
    tronc: {
        img: 'assets/sprites/rock_sprite.png',
        scale: 0.1,
        speed: 2,
        width: 20,
        height: 30,
    ...
    tronc2: {
        img: 'assets/sprites/rock_sprite2.png',
        scale: 0.1,
        speed: 2,
        width: 30,
        height: 15,
...
function preload() {
    backgroundImg = loadImage('assets/backgrounds/mountain_decor.png');
    gameOverImg = loadImage('assets/backgrounds/game_over.png');
    playAgainImg = loadImage('assets/backgrounds/play_again.png');
    loadImage('assets/sprites/car_sprite.png');
    loadImage('assets/sprites/rock_sprite.png');
    loadImage('assets/sprites/rock_sprite_2.png');

    soundFormats('mp3');
    mySound = loadSound('assets/sounds/game_music.mp3');
}
...
function draw() {
    ...
    if(gameState===END){
        ...
        lanes = [{lines: [], speed: 2}, {lines: [], speed: 2}];
        timerValue = 60;
